...
## 📈 Analytical Views
- **Sub-category Performance** → Revenue grouped by Sub-category  
- **Brand Affinity** → Revenue grouped by Brand Name  
- **Customer Activity Trend** → Month-wise aggregation of Revenue  
- **Discount Sensitivity** → Orders grouped by discount category (Low/Medium/High)  
- **Revenue by Age Group** → Revenue grouped by Age Group  
- **Ratings Distribution** → Count of Ratings (1–5)  
- **Top States by Spend** → Revenue aggregated by State  
